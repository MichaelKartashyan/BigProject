...
public class AddDisplayFlights extends JPanel implements Serializable {
    ...
    public AddDisplayFlights(MainFrameAdmin parent) {
        this.parent = parent;
        ...
        but1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                flight = new Flights(null,description,aircrafts.getId(),city1.getId(),city2.getId(),departureTime,economPrice,businessPrice);
                try{
                    pd = new PackageData("AddFlight", flight);
